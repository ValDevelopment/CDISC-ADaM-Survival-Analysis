...
knitr::kable(pooled_fisher_results, digits = 5, col.names = c("AEDECOD", "Number of Placebo Events", "Number of Dose Events", "p-value", "Adjusted p-value"),
             caption = "Significance of the 10 Most Represented Adverse Events")
```
...
knitr::kable(final_surv_df, digits = 3, col.names = c("Arm", "Survival Probability"),
             caption = "Survival Probability at End of Follow-up")
```
